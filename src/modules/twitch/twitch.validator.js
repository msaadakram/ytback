import { z } from 'zod';
import { isTwitchUrl } from './twitch.utils.js';
...
const urlField = z
    ...
    .refine(isTwitchUrl, { message: 'Only Twitch URLs are allowed' });

const qualityLabel = z
    .enum(['best', 'worst', ...Object.keys(VIDEO_QUALITIES)])
    .optional();

export const twVideoInfoSchema = z.object({
    url: urlField,
});

export const twVideoDownloadSchema = z
    .object({
        url: urlField,
...
export const twAudioDownloadSchema = z.object({
    url: urlField,
