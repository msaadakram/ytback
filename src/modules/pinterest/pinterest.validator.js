import { z } from 'zod';
import { isPinterestUrl } from './pinterest.utils.js';
...
const urlField = z
    ...
    .refine(isPinterestUrl, { message: 'Only Pinterest URLs are allowed' });

const qualityLabel = z
    .enum(['best', 'worst', ...Object.keys(VIDEO_QUALITIES)])
    .optional();

export const pinterestInfoSchema = z.object({
    url: urlField,
});

export const pinterestVideoDownloadSchema = z
    .object({
        url: urlField,
...
export const pinterestAudioDownloadSchema = z.object({
    url: urlField,
