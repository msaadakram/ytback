import { z } from 'zod';
import { isKickUrl } from './kick.utils.js';
...
const urlField = z
    ...
    .refine(isKickUrl, { message: 'Only Kick URLs are allowed' });

const qualityLabel = z
    .enum(['best', 'worst', ...Object.keys(VIDEO_QUALITIES)])
    .optional();

export const kickInfoSchema = z.object({
    url: urlField,
});

export const kickVideoDownloadSchema = z
    .object({
        url: urlField,
...
export const kickAudioDownloadSchema = z.object({
    url: urlField,
