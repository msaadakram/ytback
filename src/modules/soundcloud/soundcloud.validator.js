import { z } from 'zod';
import { isSoundCloudUrl } from './soundcloud.utils.js';
...
const urlField = z
    ...
    .refine(isSoundCloudUrl, { message: 'Only SoundCloud URLs are allowed' });

const qualityLabel = z
    .enum(['best', 'worst', ...Object.keys(VIDEO_QUALITIES)])
    .optional();

export const scInfoSchema = z.object({
    url: urlField,
});

export const scVideoDownloadSchema = z
    .object({
        url: urlField,
...
export const scAudioDownloadSchema = z.object({
    url: urlField,
