import { z } from 'zod';
import { isLinkedinUrl } from './linkedin.utils.js';
...
const urlField = z
    ...
    .refine(isLinkedinUrl, { message: 'Only LinkedIn URLs are allowed' });
...
export const linkedinVideoDownloadSchema = z
    .object({
        url: urlField,
...
export const linkedinAudioDownloadSchema = z.object({
    url: urlField,
