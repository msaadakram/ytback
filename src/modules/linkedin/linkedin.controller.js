...
export const downloadLinkedinVideo = wrapAsync(async (req, res) => {
    ...
    res.status(202).json({ success: true, data: { jobId: job.id, platform: 'linkedin', status: 'started' } });
});

export const downloadLinkedinAudio = wrapAsync(async (req, res) => {
