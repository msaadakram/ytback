import { z } from 'zod';
import { isFacebookUrl } from './facebook.utils.js';
...
const urlField = z
    ...
    .refine(isFacebookUrl, { message: 'Only Facebook URLs are allowed' });

const qualityLabel = z
    .enum(['best', 'worst', ...Object.keys(VIDEO_QUALITIES)])
    .optional();

export const fbVideoInfoSchema = z.object({
    url: urlField,
});

export const fbVideoDownloadSchema = z
    .object({
        url: urlField,
...
export const fbAudioDownloadSchema = z.object({
    url: urlField,
