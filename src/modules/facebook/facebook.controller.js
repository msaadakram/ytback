...
export const downloadFacebookVideo = wrapAsync(async (req, res) => {
    ...
    res.status(202).json({ success: true, data: { jobId: job.id, platform: 'facebook', status: 'started' } });
});

export const downloadFacebookAudio = wrapAsync(async (req, res) => {
