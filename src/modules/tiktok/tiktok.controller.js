...
export const downloadTikTokVideo = wrapAsync(async (req, res) => {
    ...
    res.status(202).json({ success: true, data: { jobId: job.id, platform: 'tiktok', status: 'started' } });
});

export const downloadTikTokAudio = wrapAsync(async (req, res) => {
