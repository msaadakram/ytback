import { z } from 'zod';
import { isTikTokUrl } from './tiktok.utils.js';
...
const urlField = z
    ...
    .refine(isTikTokUrl, { message: 'Only TikTok URLs are allowed' });

const qualityLabel = z
    .enum(['best', 'worst', ...Object.keys(VIDEO_QUALITIES)])
    .optional();

export const ttVideoInfoSchema = z.object({
    url: urlField,
});

export const ttVideoDownloadSchema = z
    .object({
        url: urlField,
...
export const ttAudioDownloadSchema = z.object({
    url: urlField,
