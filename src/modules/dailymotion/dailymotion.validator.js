import { z } from 'zod';
import { isDailymotionUrl } from './dailymotion.utils.js';
...
const urlField = z
    ...
    .refine(isDailymotionUrl, { message: 'Only Dailymotion URLs are allowed' });

const qualityLabel = z
    .enum(['best', 'worst', ...Object.keys(VIDEO_QUALITIES)])
    .optional();

export const dmVideoInfoSchema = z.object({
    url: urlField,
});

export const dmVideoDownloadSchema = z
    .object({
        url: urlField,
...
export const dmAudioDownloadSchema = z.object({
    url: urlField,
