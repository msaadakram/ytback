...
export const downloadInstagramVideo = wrapAsync(async (req, res) => {
    ...
    res.status(202).json({ success: true, data: { jobId: job.id, platform: 'instagram', status: 'started' } });
});

export const downloadInstagramAudio = wrapAsync(async (req, res) => {
