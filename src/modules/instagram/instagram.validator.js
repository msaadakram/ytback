import { z } from 'zod';
import { isInstagramUrl } from './instagram.utils.js';
...
const urlField = z
    ...
    .refine(isInstagramUrl, { message: 'Only Instagram URLs are allowed' });

const qualityLabel = z
    .enum(['best', 'worst', ...Object.keys(VIDEO_QUALITIES)])
    .optional();

export const igVideoInfoSchema = z.object({
    url: urlField,
});

export const igVideoDownloadSchema = z
    .object({
        url: urlField,
...
export const igAudioDownloadSchema = z.object({
    url: urlField,
