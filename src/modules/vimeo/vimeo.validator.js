import { z } from 'zod';
import { isVimeoUrl } from './vimeo.utils.js';
...
const urlField = z
    ...
    .refine(isVimeoUrl, { message: 'Only Vimeo URLs are allowed' });

const qualityLabel = z
    .enum(['best', 'worst', ...Object.keys(VIDEO_QUALITIES)])
    .optional();

export const vmVideoInfoSchema = z.object({
    url: urlField,
});

export const vmVideoDownloadSchema = z
    .object({
        url: urlField,
...
export const vmAudioDownloadSchema = z.object({
    url: urlField,
