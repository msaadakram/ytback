...
export const downloadNiconicoVideo = wrapAsync(async (req, res) => {
    ...
    res.status(202).json({ success: true, data: { jobId: job.id, platform: 'niconico', status: 'started' } });
});

export const downloadNiconicoAudio = wrapAsync(async (req, res) => {
