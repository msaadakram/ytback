import { z } from 'zod';
import { isNiconicoUrl } from './niconico.utils.js';
...
const urlField = z
    ...
    .refine(isNiconicoUrl, { message: 'Only Niconico URLs are allowed' });

const qualityLabel = z
    .enum(['best', 'worst', ...Object.keys(VIDEO_QUALITIES)])
    .optional();

export const niconicoInfoSchema = z.object({
    url: urlField,
});

export const niconicoVideoDownloadSchema = z
    .object({
        url: urlField,
...
export const niconicoAudioDownloadSchema = z.object({
    url: urlField,
