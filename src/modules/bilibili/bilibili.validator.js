import { z } from 'zod';
import { isBilibiliUrl } from './bilibili.utils.js';
...
const urlField = z
    ...
    .refine(isBilibiliUrl, { message: 'Only Bilibili URLs are allowed' });

const qualityLabel = z
    .enum(['best', 'worst', ...Object.keys(VIDEO_QUALITIES)])
    .optional();

export const bilibiliInfoSchema = z.object({
    url: urlField,
});

export const bilibiliVideoDownloadSchema = z
    .object({
        url: urlField,
...
export const bilibiliAudioDownloadSchema = z.object({
    url: urlField,
